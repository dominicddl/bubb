...
- [x] 01-02-PLAN.md — Backend JWT verification, health endpoints, and test suite
...
Plans:
- [x] 02-01-PLAN.md — Backend AI explain endpoint + message protocol types
- [ ] 02-02-PLAN.md — Content script selection detection, context extraction, positioning, Shadow DOM setup
- [ ] 02-03-PLAN.md — Popup React components, auto-save with undo, visual verification
