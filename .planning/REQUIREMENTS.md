...
- [x] **CORE-02**: AI explanation is contextual — adapted to surrounding page content, not a generic definition
...
- [x] **CORE-05**: Source URL and page title are stored with every note
